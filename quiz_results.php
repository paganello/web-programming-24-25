...
if (!isset($_GET['participation']) || !filter_var($_GET['participation'], FILTER_VALIDATE_INT)) {
    // Potresti usare un messaggio di errore e reindirizzare o morire con un messaggio stilizzato
    $_SESSION['error_message'] = "ID partecipazione non valido."; // Usa una variabile di sessione per i messaggi
    header('Location: index.php'); // O una pagina che mostra i quiz dell'utente
    exit;
}
